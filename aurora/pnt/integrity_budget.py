"""
Бюджет целостности AURORA PNT — диаграмма Стэнфорда, защита vs аварийные
...
def _plot_stanford(results, output_dir, label):
    ...
    ax.set_title(f"Диаграмма Стэнфорда — целостность AURORA [{label}]")
