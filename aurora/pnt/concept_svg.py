...
def _svg_service_scenarios():
    ...
    scenarios = [
        ...
        },
        {
            ...
            "color": "#fdcb6e",
            "icon":  "car",
            "details": ["Полосная точность", "Устойч. +23 дБ vs GPS", "CRPA-антенна", "32 канала", "BW 18 Гц"],
        },
        {
            ...
            "color": "#a29bfe",
            "icon":  "tower",
            "details": ["Cs: 0,01 нс/6ч", "6 ISL-хопов: 2,58 нс", "PTP IEEE 1588", "Замена GPS-синхрон.", "UTC(SU) < 5 нс"],
        },
    ]
...
def _svg_leo_vs_meo():
    ...
    systems = [
        {
            ...
            "params": [
                ...
                ("Усиление vs GPS",          "+23 дБ  (×200 по мощн.)", "#00b894"),
        ...
        {
            "cx": 1060, "col": "#e17055", "label": "GPS MEO",
            "sub": "h = 20 200 км", "sat_y": 135, "sat_sz": 30,
            "earth_r": 290, "earth_cy": 950,
            "beam_w": 8, "beam_op": 0.12,
            "params": [
                ("Уровень сигнала (EIRP)",  "−158 дБВт", "#e17055"),
                ("Потери в пространстве",   "−182 дБ (20 200 км)", "#e17055"),
                ("Усиление vs GPS",          "0 дБ (референс)", "#8b949e"),
    ...
    parts.append(f'<text x="{W//2}" y="36" text-anchor="middle" '
                 ...
                 f'fill="white" filter="url(#text_glow)">'
                 f'AURORA LEO vs GPS MEO — Преимущество сигнала и характеристики</text>')
