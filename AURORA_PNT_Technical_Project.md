...
Это означает, что спутник АВРОРА проходит видимую часть небосвода за **10–13 минут** (высокий проход, маска 10°), тогда как MEO-спутник GPS остаётся в зоне видимости несколько часов. Высокая динамика определяет требования к ширине полосы следящих фильтров и к частоте смены рабочих спутников.
...
Для АВРОРА (зенит): $\Delta = 52{,}6 - 25 = 27{,}6$ дБ → помехе нужна мощность в $10^{2{,}76} \approx 575$ раз больше, чем для подавления GPS на той же высоте.
...
- GPS: $P_{jam}$ ≈ 1 Вт
- АВРОРА: $P_{jam}$ ≈ 575 Вт (превышение в 575 раз)
