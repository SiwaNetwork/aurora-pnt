...
### 45.2 Критические технические риски
...
| ИТУ координация — отказ в выделении частот | Низкая | Критическое | TMBOC/BPSK в рамках RNSS-полос M.1787; SSC < −61 дБ/Гц подтверждён §45 |
| Кибератака на TESLA MAC / НС | Низкая | Высокое | HMAC-SHA256 128 бит, смена ключа 30 с, аппаратный HSM на МКС |

### 45.3 Рекомендации по дальнейшей разработке
