...
$$\mathrm{LCC} = \mathrm{NRE} + \sum_{n=1}^{300} T_1 \cdot n^{\log_2 b} + C_{launch} + C_{ground} + \mathrm{OPEX}\cdot Y$$

Кривая обучения Райта $b = 0{,}85$; $T_1 = 360$ млн ₽ — стоимость первого лётного КА (по аналогии с малыми GNSS-КА класса 140 кг). Все суммы — в рублях; справочный пересчёт по курсу 90 ₽/$.
...
| Серия 300 КА (кривая обучения) | 36 803 | 408,9 |
| Запуски (25 × 1 080) | 27 000 | 300 |
| Наземный сегмент (CAPEX) | 7 200 | 80 |
| OPEX за 7 лет (3 600 × 7) | 25 200 | 280 |
| **LCC за 7 лет** | **107 003 млн ₽ ≈ 107 млрд ₽** | **1 189** |
| **LCC за 15 лет** | **135 803 млн ₽ ≈ 135,8 млрд ₽** | **1 509** |
| Стоимость на 1 КА (7 лет) | 357 млн ₽ | 3,96 |
| Стоимость в год (среднее за 7 лет) | 15 286 млн ₽/год | 169,8 |
