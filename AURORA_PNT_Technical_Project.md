...
| Удельная LCC на 1 КА (вся программа ÷ 300: NRE+запуск+земля+7 лет OPEX) | 339 млн ₽ | 3,77 |
| Стоимость в год (среднее за 7 лет) | 14 507 млн ₽/год | 161,2 |

Важно различать **цену изготовления спутника** (серийная, с кривой обучения — **≈ 105 млн ₽**, что нормально для 140-кг нав-смолсата с атомными часами и ISL) и **удельную LCC на КА** (339 млн ₽) — последняя включает разработку, запуск, наземный сегмент и 7 лет эксплуатации, размазанные на 300 аппаратов, и не является ценой постройки одного КА. Для сравнения: программы GPS/Galileo стоят $10+ млрд — АВРОРА (≈ 101,5 млрд ₽ ≈ $1,1 млрд за 7 лет) дешевле на порядок за счёт малых КА, отечественных часов и серийности.
