...
![AURORA LEO vs GPS MEO](results/system_concept/concept_leo_vs_meo_phase4.png)

*LEO-орбита 1000 км обеспечивает на +23 дБ более сильный сигнал по сравнению с GPS MEO. Это эквивалентно 200-кратному увеличению устойчивости к подавлению. Обратная сторона — более высокий Доплер (±38,6 кГц, 38,6 Гц/с) и короткое время пролёта (~11 мин), что определяет требования к приёмнику (§42).*
...
Для сравнения: GPS C/N₀ на L1 ≈ 42–47 дБ-Гц.
...
### 36.3 Время сходимости AURORA vs GPS
