...
| Миниат. CSAC (КПН), класс SA.45s, 20 крад | 3 × 10⁻¹⁰ | −0,50 | Все КА — терминальный стандарт |
...
чип-масштабный атомный стандарт CSAC (КПН) класса Microsemi SA.45s: ≈35 г, ≈0,12 Вт,
радиационная стойкость 20 крад (SEU до 64 МэВ·см²/мг), непрерывно дисциплинируется по
ISL/навигационному сигналу. Якорный (≈15 КА) — космический рубидий Quantum-18 (ООО «ШИВА НЕТВОРК»),
≈1,8 кг, для удержания при потере связи и анкеровки ISL-шкалы. Наземный эталон UTC(SU) —
группа активных водородных мазеров Ч1-1008 (ВРЕМЯ-Ч). Полноразмерный цезий на борту не
применяется.
