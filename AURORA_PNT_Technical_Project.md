...
| OP-03 | Деградация точности при автономии (72 ч без земли) не промоделирована поэпизодно | Прогон роста UERE/CEP на space-Rb-якорях за 24–72 ч |
| OP-04 | Модуль `agps_server` (сокращение холодного TTFF) не реализован | Реализовать (роадмап §22) |
| OP-05 | Роадмап режим A (UERE 3,1 м) — сценарий продлённой автономии, а не норма (0,7 м, §8.6) | Явно пометить как деградацию, отделить от нормального режима |
