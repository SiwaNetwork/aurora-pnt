...
> Динамика покрытия (движение группировки, бегущие зоны видимости и N_vis(t) для
> наземного пользователя) представлена видео `results/constellation_anim/constellation_flyby_phase4.mp4`
> (H.264, 1560×1020; CLI `constellation-anim`).
...
**Статус элементной базы (см. OP-06, §67.4).** Космический рубидий **Quantum-18 разрабатывается ООО «ШИВА НЕТВОРК» в параллельном проекте** (собственная разработка стандарта частоты). Терминальный **CSAC**: ведётся **поиск партнёра** для создания/локализации чип-масштабного цезиевого стандарта; до его готовности в проекте заданы граничные ТТХ (Таблица 19) и предусмотрена квалификация на демонстраторах Фаз 0–1 (§4.3, §66).
...
| OP-06 | Элементная база бортовых часов | space-Rb **Quantum-18 — собственная разработка ООО «ШИВА НЕТВОРК» в параллельном проекте** (стандарт частоты); терминальный **CSAC — ведётся поиск партнёра** для создания/локализации. Вне периметра настоящего ТП: ТТХ зафиксированы (§8, Таблица 19), квалификация — на демонстраторах Фаз 0–1 |
