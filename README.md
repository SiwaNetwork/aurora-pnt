...
Данный репозиторий содержит **полный фреймворк моделирования** — 20+ аналитических модулей, покрывающих все аспекты системы: орбитальную геометрию, точность позиционирования, синхронизацию времени, помехозащищённость, аутентификацию, ISL-связь и живучесть.
